  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/80 backdrop-blur-sm p-4 font-poppins">
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 border border-gray-200 shadow-2xl relative space-y-6">
        ...
        {/* PASO 1: ADVERTENCIA Y VERIFICACIÓN PRE-PAGO */}
          ...
          <div className="space-y-5">
            <div className="p-4 bg-amber-50 border border-amber-200 rounded-2xl space-y-2">
              ...
              <p className="text-xs text-amber-800/90 leading-relaxed font-medium">
                Por favor, verifica detalladamente la ortografía, números de teléfono y datos personales antes de proceder. 
                <strong className="block mt-1 text-amber-950">
                  ¡Nota Pro! Una vez procesado el pago, podrás editar este CV libremente sin volver a pagar.
                </strong>
              </p>
            </div>
            ...
            <label className="flex items-start gap-3 p-3 bg-gray-50 border border-gray-200 rounded-2xl cursor-pointer hover:bg-gray-100 transition-colors">
              <input
                ...
                className="mt-1 rounded border-gray-300 text-amber-500 focus:ring-amber-400 w-4 h-4"
              />
              <span className="text-xs text-gray-700 font-medium">
                Confirmo que he revisado minuciosamente mis datos y estoy listo para procesar mi plantilla.
              </span>
            </label>
            ...
            >
              <span>Continuar a Pasarela de Pago (${priceAmount} USD)</span>
            </button>
          </div>
        )}
          ...
          <div className="space-y-5">
            {isFreeToExport ? (
              <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-2xl space-y-2 text-center">
                ...
                <h4 className="text-xs font-black text-emerald-950 uppercase tracking-wider">
                  {isB2B ? 'Licencia B2B Empresarial Activa' : 'Pago Confirmado para esta Plantilla'}
                </h4>
                <p className="text-xs text-emerald-800 font-medium">
                  Tu PDF se generará en formato Carta Vectorial (8.5&quot; x 11&quot;) sin marcas de agua.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                <div className="p-3.5 bg-gray-50 border border-gray-200 rounded-2xl flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500">Acceso ilimitado de edición para esta plantilla</p>
                  </div>
                  <span className="text-lg font-black text-amber-600 font-mono">${priceAmount} USD</span>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-1.5 text-[11px] font-bold text-gray-500 uppercase tracking-wider justify-center">
                    ...
                    <span>ADVERTENCIA 2 DE 2: Pago Seguro Procesado por PayPal</span>
                  </div>
            ...
            {isFreeToExport && (
              ...
              >
                ...
                <span>Descargar PDF Vectorial Gratis</span>
              </button>
            )}
          </div>
        )}
